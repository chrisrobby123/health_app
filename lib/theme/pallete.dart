...
import 'package:health_app/pallete.dart';
...
class ThemeText {
  static var textThemeData = const TextTheme().copyWith(
...
class ThemeNotifier extends StateNotifier<ThemeData> {
  ...
  ThemeNotifier({ThemeMode mode = ThemeMode.dark})
      : _mode = mode,
        super(ThemeText.darkModeAppTheme) {
    getTheme();
  }
  ...
  void getTheme() async {
    ...
    if (theme == 'light') {
      ...
      state = ThemeText.lightModeAppTheme;
    } else {
      _mode = ThemeMode.dark;
      state = ThemeText.darkModeAppTheme;
    }
  }
